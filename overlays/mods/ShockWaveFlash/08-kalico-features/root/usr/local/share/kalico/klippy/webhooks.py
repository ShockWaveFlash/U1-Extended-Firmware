...
class ServerSocket:
    def __init__(self, webhooks, printer):
        ...
        # Snapmaker/klippy.py uebergibt den Socketpfad als "apiserver";
        # Kalico nennt ihn "apiserver_file". Beides akzeptieren, sonst
        # wird der Moonraker-Socket stillschweigend nicht angelegt.
        server_address = start_args.get("apiserver_file") or start_args.get(
            "apiserver"
        )
...
class ClientConnection:
    ...
    def send(self, data):
        try:
            # Snapmaker: orjson-Schnellpfad; json_compat._default deckt die
            # numpy-Typen aus Kalicos _json_convert mit ab
