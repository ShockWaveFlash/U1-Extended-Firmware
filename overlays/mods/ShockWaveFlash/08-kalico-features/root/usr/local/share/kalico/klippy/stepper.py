...
class MCU_stepper:
    def __init__(
        ...
        self._stepper_type, self._stepper_index = get_stepper_type_and_index(
            self._name
        )
...
class PrinterRail:
    def __init__(
        ...
        self.homing_backoff_dist = config.getfloat("homing_backoff_dist", 0.0)
        self.homing_tolerance = config.getfloat(
            "homing_tolerance", None, minval=0.0
        )
        ...
        self.homing_before_delay = config.getfloat(
            "homing_before_delay", 0.0, minval=0
        )
        self.second_homing_before_delay = config.getfloat(
            "second_homing_before_delay", 0.0, minval=0
        )
    ...
    def get_homing_info(self):
        homing_info = collections.namedtuple(
            ...
            self.homing_tolerance_retries,
            self.homing_before_delay,
            self.second_homing_before_delay,
            self.homing_samples,
            self.homing_backoff_dist,
        )
        return homing_info
