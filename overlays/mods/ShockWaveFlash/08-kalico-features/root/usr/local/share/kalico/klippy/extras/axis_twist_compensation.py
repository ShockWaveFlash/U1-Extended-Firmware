...
from . import bed_mesh, manual_probe, probe
...
class AxisTwistCompensation:
    ...
    # Snapmaker: Hook fuer das Event "probe:update_results" - veraendert pos
    # in-place; probe.py ruft get_z_compensation_value() NICHT auf.
    def _update_z_compensation_value(self, pos):
        pos[2] += self.get_z_compensation_value(pos)
