...
class CalibrationState:
    ...
    def calibrate_z(self):
        ...
        # Merge-Anpassung: multi_probe_begin/end gibt es nur auf dem
        # mcu_probe, nicht auf PrinterProbe. start_probe_session ruft
        # intern mcu_probe.multi_probe_begin() - gleiche Semantik.
        probe_session = self.probe.start_probe_session(self.gcmd)
