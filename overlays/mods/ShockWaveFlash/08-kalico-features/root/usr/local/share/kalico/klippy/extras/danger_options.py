...
class DangerOptions:
    def __init__(self, config: ConfigWrapper):
        ...
        # Merge-Anpassung: Snapmaker hatte TRSYNC_TIMEOUT = 0.050 fest
        # verdrahtet (siehe mcu.py). Der U1 homed ueber mcu + e0..e3, also
        # immer ueber den Multi-MCU-Pfad. Kalicos Default 0.025 wuerde das
        # Zeitfenster halbieren -> "Communication timeout during homing".
