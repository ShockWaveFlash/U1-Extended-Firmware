...
class PrinterADCtoTemperature:
    def __init__(self, config, adc_convert):
        ...
        self.report_time_delta = config.getfloat(
            "report_time_delta", REPORT_TIME, above=0.0
        )
        self.mcu_adc.setup_adc_callback(
            self.report_time_delta, self.adc_callback
        )
    ...
    def setup_minmax(self, min_temp, max_temp):
        # Kalico: danger_options koennen die ADC-Bereichspruefung abschalten
