...
struct stepcompress {
    ...
    uint32_t oid;
    // Snapmaker: G-Code-Zeilennummer des laufenden Zuges. Beim Auto-Merge
    // mit bleeding-edge-v2 aus dem Struct gefallen, ohne sie bricht der
    // Build mit 6 Fehlern ab.
    uint32_t move_line;
    ...
    // Extra fields for high precision algorithm
